...
export const ESTILOS_PARAGRAFO_LEGISLATOR = [
  ...
  { node: 'epigrafe', label: 'Epígrafe', atalho: '⌘⌥1', nivel: 1, xmlTag: 'Epigrafe', htmlImport: 'h1.tit-subtit_epigrafe, h1.tit-subtit_epigrafe-quebra, p.tit-subtit_epigrafe, p.tit-subtit_epigrafe-quebra', cssClass: 'epigrafe', disponibilidade: 'todos' },
  ...
  { node: 'ementa', label: 'Ementa', atalho: '⌘⌥2', xmlTag: 'Ementa', htmlImport: 'p.corpo-legis_ementa', cssClass: 'ementa', disponibilidade: 'todos' },
